...
router.get('/view', function (req, res, next) {
  ...
  try{
    knex.raw('SELECT "ID", "ParagraphIndex", "Snippet", "FromLanguage", "ToLanguage", "Payment", "ContractAddress" FROM "Passage" RIGHT JOIN "Paragraph" on "Passage"."ID" = "Paragraph"."PassageID" WHERE "Paragraph"."Translated" <> true')
